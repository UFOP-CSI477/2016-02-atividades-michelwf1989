...
<div class="container well">
	<div class="col-sm-2">
		...
		<ul class="nav nav-pills nav-stacked">
			<li align= "center">
				<?= $this->Html->link("Relação de Produtos", array('controller' => 'users', 'action' => 'index2')); ?>
			</li
	...
	<div class="col-sm-8 col-sm-offset-1" id="conteudo">
		<h1 align="center">Incluir Produtos</h1>

		<?php echo $this->Form->create('Produto', array('controller' => 'users', 'url' => 'incluirProduto')); ?>
			...
			<div class="col-sm-12 center-block">
                <?php echo $this->Form->submit('Cadastrar Produto', array('class' => 'btn btn-lg btn-secondary btn-block')); ?>
            </div>
